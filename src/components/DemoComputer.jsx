...
const DemoComputer = (props) => {
  ...
  const txt =
    props.texture.endsWith('jpg') || props.texture.endsWith('png')
      ? useTexture(props.texture || '/textures/project/project1.jpg')
      : useVideoTexture(props.texture || '/textures/project/projectx.mp4');
